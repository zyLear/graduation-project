...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row custom-content">
            ...
            <%--<div class="col-sm-7">--%>
            <%--<input type="text" class="form-control" id="application-department"--%>
            <%--placeholder="申请部门">--%>
            <%--</div>--%>
            <%--</div>--%>
            <%--<div class="form-group">--%>
            ...
            <%--<div class="col-sm-7">--%>
            <%--<input disabled type="text" class="form-control" id="project-budget"--%>
            <%--placeholder="项目预算">--%>
            <%--</div>--%>
            <%--</div>--%>
            ...
            <div class="col-lg-offset-1 col-lg-10">
                ...
                <%--<button id="add-budget" type="button" class="btn btn-info btn-lg"> 新增预算</button>--%>
                <%--</div>--%>
