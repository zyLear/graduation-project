            ...
            <div class="col-lg-offset-1 col-lg-10">
                ...
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select readonly id="contractNumber" name="contractNumber" class="form-control">
                                <option value="${contract.contractNumber}">${contract.contractNumber}
